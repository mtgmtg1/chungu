...
- When calling add_text_highlight, add_line_highlight, add_sticky_note, or add_text_callout in batch mode, pass page_no as an array of NUMBERS (e.g. page_no: [1, 2]) or a single scalar number (e.g. page_no: 1). NEVER pass strings (e.g. "1" or ["1", "2"]). If all texts are on the same page, pass a single number page_no: 1 for maximum efficiency.
