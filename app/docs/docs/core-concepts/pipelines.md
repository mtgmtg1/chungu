...
The premium model uses Gemma 4 AI (26B) vision model for all pages, providing superior accuracy for complex documents, scanned images, handwritten text, rotated pages, and tables.
