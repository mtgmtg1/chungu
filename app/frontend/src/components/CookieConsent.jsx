      ...
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-4">
        ...
        <div className="flex gap-3 shrink-0">
          <button
            ...
            className="text-sm text-gray-300 hover:text-white px-4 py-2 rounded-lg border border-gray-600 hover:border-gray-400 transition-colors"
          >
            {t("legal.cookie.decline")}
          </button>
          <button
            onClick={handleEssentialOnly}
            className="text-sm text-gray-200 hover:text-white px-4 py-2 rounded-lg border border-gray-500 hover:border-gray-300 transition-colors"
          >
