// [Flow: Step 1 (마운트 시 WebGL 렌더러/씨/셰이더 생성) -> Step 2 (마우스/웹캠/자이로 입력으로 시점 타겟 갱신) -> Step 3 (매 프레임 smoothDamp 보간 및 셰이더 유니폼 갱신) -> Step 4 (후처리 파이프라인 또는 직접 렌더링) -> Step 5 (언마운트 시 리소스 해제)]
import {
  BloomEffect,
